...
#' @export
dme_create_daisie_input_cpp <- function(dme_params_filename, daisie_sim_results_filename, daisie_input_ideal_filename, daisie_input_reality_filename, daisie_output_ideal_filename, daisie_output_reality_filename) {
    invisible(.Call(`_daisieme_dme_create_daisie_input_cpp`, dme_params_filename, daisie_sim_results_filename, daisie_input_ideal_filename, daisie_input_reality_filename, daisie_output_ideal_filename, daisie_output_reality_filename))
}
